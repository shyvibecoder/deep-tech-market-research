...
export function macroStress({ vix, vix3m, hygMom1m } = {}) {
  const term_inverted = vix != null && vix3m != null && vix3m > 0 && vix / vix3m >= TERM_INVERT;
  const hy_stressed = hygMom1m != null && hygMom1m <= HY_VELOCITY;
  const reasons = [];
  ...
  return {
    ...
    vix_term: vix != null && vix3m ? +(vix / vix3m).toFixed(3) : null,
    hy_mom_1m: hygMom1m ?? null,
    reasons,
  };
}
